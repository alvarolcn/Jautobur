...
public class Bearing {
     ...
     * @return The bearing
     */
    public static Bearing calculateBearing(OsmNode pt1, OsmNode pt2,
                                           Bearing result) {

        return calculateBearing(defaultEarth, pt1.getLat(),
                                pt1.getLon(), pt2.getLat(),
                                pt2.getLon(), result);
    }
     ...
     * from North, 0 to 360), from latitude-longitude point pt1 to
     * latitude-longitude pt2.
     *
     ...
     */
    public static OsmNode findPoint(OsmNode pt1, double az,
                                            double dist,
                                            OsmNode result) {
        return findPoint(defaultEarth, pt1.getLat(), pt1.getLon(),
                         az, dist, result);
    }
     ...
     */
    public static OsmNode findPoint(Earth e, double lat1,
                                            double lon1, double az,
                                            double dist,
                                            OsmNode result) {
        if (result == null) {
            result = new OsmNode(-99999);
        }
        ...
        result.setLat(GLAT2 * deg);
        result.setLon(GLON2 * deg);
        return result;
    }
